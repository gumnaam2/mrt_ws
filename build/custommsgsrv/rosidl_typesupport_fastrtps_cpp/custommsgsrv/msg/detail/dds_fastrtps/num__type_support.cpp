...
#include "custommsgsrv/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custommsgsrv::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custommsgsrv::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custommsgsrv::msg::Num *>(
    untyped_ros_message);
...
{
  return &custommsgsrv::msg::typesupport_fastrtps_cpp::_Num__handle;
}
