...
#include "custommsgsrv/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custommsgsrv::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custommsgsrv::msg::Sphere & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custommsgsrv::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custommsgsrv::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custommsgsrv::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &custommsgsrv::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custommsgsrv, msg, Sphere)() {
  return &custommsgsrv::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
