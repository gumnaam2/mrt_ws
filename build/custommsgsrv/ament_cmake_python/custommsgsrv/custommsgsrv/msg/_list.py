...
class List(metaclass=Metaclass_List):
    ...
    def __init__(self, **kwargs):
        ...
        self.polygon = array.array('f', kwargs.get('polygon', []))
    ...
    def polygon(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'f', \
                "The 'polygon' array.array() must have the type code of 'f'"
            self._polygon = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'polygon' field must be a set or sequence and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
        self._polygon = array.array('f', value)
