...
bool custommsgsrv__srv__imgservice__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custommsgsrv.srv._imgservice.Imgservice_Request", full_classname_dest, 47) == 0);
  }
  custommsgsrv__srv__Imgservice_Request * ros_message = _ros_message;
  {  // img
...
{
  /* NOTE(esteve): Call constructor of Imgservice_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custommsgsrv.srv._imgservice");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Imgservice_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool custommsgsrv__srv__imgservice__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custommsgsrv.srv._imgservice.Imgservice_Response", full_classname_dest, 48) == 0);
  }
  custommsgsrv__srv__Imgservice_Response * ros_message = _ros_message;
  {  // corners
...
{
  /* NOTE(esteve): Call constructor of Imgservice_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custommsgsrv.srv._imgservice");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Imgservice_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
