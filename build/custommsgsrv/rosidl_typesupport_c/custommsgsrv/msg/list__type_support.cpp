...
static const _List_type_support_symbol_names_t _List_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custommsgsrv, msg, List)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custommsgsrv, msg, List)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custommsgsrv, msg, List)() {
  return &::custommsgsrv::msg::rosidl_typesupport_c::List_message_type_support_handle;
}
