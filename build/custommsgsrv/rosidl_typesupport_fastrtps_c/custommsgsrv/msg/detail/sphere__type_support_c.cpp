...
#include "custommsgsrv/msg/detail/sphere__rosidl_typesupport_fastrtps_c.h"
...
using _Sphere__ros_msg_type = custommsgsrv__msg__Sphere;
...
size_t get_serialized_size_custommsgsrv__msg__Sphere(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Sphere__ros_msg_type * ros_message = static_cast<const _Sphere__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Sphere__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custommsgsrv__msg__Sphere(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custommsgsrv
size_t max_serialized_size_custommsgsrv__msg__Sphere(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custommsgsrv__msg__Sphere;
    is_plain =
      (
...
static size_t _Sphere__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custommsgsrv__msg__Sphere(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custommsgsrv, msg, Sphere)() {
