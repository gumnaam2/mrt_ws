...
#include "custommsgsrv/msg/detail/list__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // polygon
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // polygon

// forward declare type support functions


using _List__ros_msg_type = custommsgsrv__msg__List;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: polygon
  {
    ...
    if (ros_message->polygon.data) {
      rosidl_runtime_c__float__Sequence__fini(&ros_message->polygon);
    }
...
size_t get_serialized_size_custommsgsrv__msg__List(
  const void * untyped_ros_message,
...
static uint32_t _List__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custommsgsrv__msg__List(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custommsgsrv
size_t max_serialized_size_custommsgsrv__msg__List(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custommsgsrv__msg__List;
    is_plain =
      (
...
static size_t _List__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custommsgsrv__msg__List(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custommsgsrv, msg, List)() {
