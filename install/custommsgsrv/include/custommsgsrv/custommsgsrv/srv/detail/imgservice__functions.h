...
#ifndef CUSTOMMSGSRV__SRV__DETAIL__IMGSERVICE__FUNCTIONS_H_
#define CUSTOMMSGSRV__SRV__DETAIL__IMGSERVICE__FUNCTIONS_H_
...
/// Initialize srv/Imgservice message.
/**
...
/// Finalize srv/Imgservice message.
/**
...
/// Create srv/Imgservice message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custommsgsrv__srv__Imgservice_Request__init().
...
/// Destroy srv/Imgservice message.
/**
 * It calls
 * custommsgsrv__srv__Imgservice_Request__fini()
...
/// Check for srv/Imgservice message equality.
/**
...
/// Initialize array of srv/Imgservice messages.
/**
...
/// Finalize array of srv/Imgservice messages.
/**
 * It calls
 * custommsgsrv__srv__Imgservice_Request__fini()
...
/// Create array of srv/Imgservice messages.
/**
 * It allocates the memory for the array and calls
 * custommsgsrv__srv__Imgservice_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Imgservice messages.
/**
 * It calls
 * custommsgsrv__srv__Imgservice_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Imgservice message array equality.
/**
...
/// Copy an array of srv/Imgservice messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custommsgsrv__srv__Imgservice_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custommsgsrv
...
/**
 * It calls
 * custommsgsrv__srv__Imgservice_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custommsgsrv
...
/**
 * It allocates the memory for the array and calls
 * custommsgsrv__srv__Imgservice_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custommsgsrv
...
/**
 * It calls
 * custommsgsrv__srv__Imgservice_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOMMSGSRV__SRV__DETAIL__IMGSERVICE__FUNCTIONS_H_
